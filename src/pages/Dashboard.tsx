...
export function Dashboard() {
    ...
    return (
        <div className="bg-gray-500 rounded-xl p-10 md:min-w-[768px]">
            ...
            <form onSubmit={onSubmit} className="flex items-center justify-between pb-6 border-b-[1px] border-b-gray-400 md:flex-row gap-2 mt-6 flex-1">
